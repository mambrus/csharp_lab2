...
namespace VotingService
{
    ...
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        // The following two are lexically re-written
        /*
        ...
        */
        ...
        [Event(ServiceRequestStartEventId,
            Level = EventLevel.Informational,
            Message = "Service request '{0}' started. Activity id: {1}",
            Keywords = Keywords.Requests)]
        public void ServiceRequestStart(string requestTypeName,
            string activityID = "")
        {
            WriteEvent(ServiceRequestStartEventId,
                requestTypeName,
                activityID);
        }
        ...
        [Event(ServiceRequestStopEventId,
            Level = EventLevel.Informational,
            Message = "Service request '{0}' finished. Activity id: {1}",
            Keywords = Keywords.Requests)]
